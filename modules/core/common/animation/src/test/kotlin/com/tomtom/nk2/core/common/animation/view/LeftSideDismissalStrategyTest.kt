...
class LeftSideDismissalStrategyTest : DismissalStrategyTestCase() {
    private val sut = LeftSideDismissalStrategy(mockContext, DISMISS_VIEW_WIDTH_THRESHOLD)
    ...
    @Test
    fun `Do not dismiss if very dragged right from default position`() {
        // GIVEN
        val view = viewAtPosition(DEFAULT_VIEW_POSITION)
