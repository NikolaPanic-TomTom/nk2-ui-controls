...
class RightSideDismissalStrategyTest : DismissalStrategyTestCase() {
    private val sut = RightSideDismissalStrategy(mockContext, DISMISS_VIEW_WIDTH_THRESHOLD)
    ...
    @Test
    fun `Do not dismiss if very dragged left from default position`() {
        // GIVEN
        val view = viewAtPosition(DEFAULT_VIEW_POSITION)
